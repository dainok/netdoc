    ...
    for interface_o in queryset:
        ...
        if device_id not in nodes:
            ...
            nodes[device_id] = {
                ...
                "image": image_url,
                "shape": "image",
                "title": Template(NODE_TEMPLATE, autoscape=select_autoescape(enabled_extensions=['html'], default_for_string=True)).render(device=device_o),
            }
            # Set position
        ...
        if cable_id not in links:
            ...
            if (
                ...
                links[cable_id] = {
                    ...
                    "title": Template(CABLE_TEMPLATE, autoscape=select_autoescape(enabled_extensions=['html'], default_for_string=True)).render(
        ...
        for address_o in interface_o.ip_addresses.all():
            ...
            if network_id not in networks:
                networks[network_id] = {
                    ...
                    "title": Template(NETWORK_TEMPLATE, autoscape=select_autoescape(enabled_extensions=['html'], default_for_string=True)).render(
